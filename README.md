...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/anu)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/anu
```

A live public deployment of this template is available at [https://anu.templates.workers.dev](https://anu.templates.workers.dev)
